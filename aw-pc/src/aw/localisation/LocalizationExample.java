...
*/
public class LocalizationExample implements StoppableRunnable {
	...
	public LocalizationExample(MovableRobot _robot, GridMap _gridMap,
	...
	public void run() {
		...
		ActionModel actionModel = new PerfectActionModel1();
	...
	public static void main(String[] args) {
		...
		LocalizationExample ml = new LocalizationExample(
